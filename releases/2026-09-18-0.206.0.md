...
![La même page de livre dans les quatre modes](../assets/0.206.0/themes-4.png)

Clair, sombre, Cozy et Papier Crème. Le mode se change dans
**Réglages › Modes clair, sombre, cozy**, et l'application entière suit —
les couvertures, les graphiques et jusqu'aux polices de caractères.

![Le choix du mode dans les réglages](../assets/0.206.0/themes.png)

### Votre journal réunit le calendrier et les statistiques

![Le journal de lecture, semaine par semaine](../assets/0.206.0/journal-semaine.png)
...
> Les captures illustrant les versions de mai à juillet ont été prises dans
> l'application telle qu'elle est aujourd'hui : l'écran a pu évoluer depuis la
> version où la fonctionnalité est apparue.
